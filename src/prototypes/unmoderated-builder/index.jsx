/**
 * Unmoderated Builder Prototype
 * 
 * A high-fidelity reproduction of the Maze unmoderated study builder layout.
 * 
 * Layout Structure:
 * ┌──────────────────────────────────────────────────────────────────────┐
 ...
 * └─────────────┴─────────────────────┴──────────────────────────────────┘
 * 
 * Based on: maze-webapp/src/components/CreateMaze/
 */
...
/**
 * UnmoderatedBuilder - Main prototype component
 * 
...
UnmoderatedBuilder.Title = "Unmoderated Builder";
UnmoderatedBuilder.Description = "Baseline prototype mirroring production — use as a reference point for new explorations";
UnmoderatedBuilder.Order = 20;
UnmoderatedBuilder.Group = "Unmoderated Studies";
UnmoderatedBuilder.StateControls = {
  useCase: {
    label: 'Use Case',
    type: 'select',
...
export default UnmoderatedBuilder;
