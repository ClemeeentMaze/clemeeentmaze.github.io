...
ThematicAnalysisV1.Title = "Highlight Creation V2 - Expanded Card";
ThematicAnalysisV1.Description = "Click a response to expand into a full card with transcript, video, and highlight tools";
