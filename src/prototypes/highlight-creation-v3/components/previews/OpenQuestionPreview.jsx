 ...
 * Displays title, description, textarea input, and Continue button.
 * 
 * Based on: Figma design node 4228:88064
 */
import { Flex, Box, Text, Heading, CTAButton, ProgressBar, TextAreaControl } from '@framework/components/ariane';
