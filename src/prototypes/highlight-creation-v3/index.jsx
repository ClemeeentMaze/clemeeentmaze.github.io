...
ThematicAnalysisV1.Title = "Highlight Creation V3 - Split Panel";
ThematicAnalysisV1.Description = "Split view with responses list on left, detail panel with video/transcript on right";
