 ...
 */
export function OpenQuestionPreview({ block, isModerated = false, progress = 10 }) {
  // Use conversational UI whenever the block is AI moderated.
  const isConversational = Boolean(isModerated || block?.conversationalEnabled);
