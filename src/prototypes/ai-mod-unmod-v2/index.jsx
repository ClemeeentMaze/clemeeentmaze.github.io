...
AiModUnmodV2.Title = "V2 - Conversational Open Question";
AiModUnmodV2.Description = "Open Question block with optional conversational AI mode";
AiModUnmodV2.Order = 20;
AiModUnmodV2.Group = "AI moderation in unmoderated";
AiModUnmodV2.StateControls = {
  selectedBlockType: {
