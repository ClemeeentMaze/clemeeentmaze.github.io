...
export function BlockListItem({ block, isSelected, onSelect }) {
  ...
  const iconName = isAIModeratedOpenQuestion ? 'ai-block' : (blockType.iconName || 'block');
  const iconColor = blockType.arianeColor || 'primary';
  ...
  return (
    ...
    >
      <Flex gap="SM" alignItems="center">
        ...
        {/* Shows AI icon when conversational mode is enabled for Open Question */}
        <IconFigure 
          name={iconName}
          color={iconColor}
          mode="dark"
