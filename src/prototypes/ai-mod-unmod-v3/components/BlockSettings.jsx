 ...
 */
function BlockSettingsContent({ block, onBlockChange, isStudyModerated }) {
  ...
  return (
    <SettingsComponent
      ...
      isStudyModerated={isStudyModerated}
    />
  );
}
 ...
 * @param {boolean} props.isStudyModerated - Study-level AI moderation state
 */
export function BlockSettings({ block, onBlockChange, isStudyModerated }) {
  if (!block) {
    return (
      <Flex 
        alignItems="center" 
