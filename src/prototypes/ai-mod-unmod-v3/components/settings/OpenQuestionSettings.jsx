 ...
 */
export function OpenQuestionSettings({ block, onBlockChange, isStudyModerated }) {
    ...
    <Flex flexDirection="column" gap="LG" className="w-full">
      ...
      <Flex flexDirection="column" gap="SM" className="w-full">
        ...
        <Text type="caption" color="default.main.secondary">
          Follow-up prompts are available when study moderation is enabled.
        </Text>
      </Flex>
      ...
      {isStudyModerated ? (
        ...
        <Text type="caption" color="default.main.secondary">
          Turn on study moderation to add AI follow-ups here.
        </Text>
      )}
