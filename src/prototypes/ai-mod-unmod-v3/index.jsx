/**
 * Dedicated AI Mod Block
 * 
 * Exploration of a dedicated AI moderation block within unmoderated studies.
...
/**
 * AiModUnmodV1 - Main prototype component
 * 
...
function AiModUnmodV3() {
  ...
  const [studyModerationEnabled, setStudyModerationEnabled] = useState(true);
        ...
        */}
        <Box className="w-[360px] min-w-[360px] flex-shrink-0 h-full">
          <BlockList
            ...
            studyMeta={studyMeta}
            studyModerationEnabled={studyModerationEnabled}
            onStudyModerationToggle={setStudyModerationEnabled}
          />
        </Box>
        ...
        */}
        ...
        >
          <BlockSettings
            ...
            isStudyModerated={studyModerationEnabled}
          />
        </Box>
...
AiModUnmodV3.Title = "V3 - Study-level AI moderation";
AiModUnmodV3.Description = "Single study-level moderation setting that affects all blocks";
AiModUnmodV3.Order = 30;
AiModUnmodV3.Group = "AI moderation in unmoderated";
AiModUnmodV3.StateControls = {
  selectedBlockType: {
