...
export const BLOCK_TYPES = {
  ...
  conversational: {
    ...
    iconName: 'ai-block',
    arianeColor: 'lila',
    description: 'AI-moderated interview style conversation',
  },
  simple_input: {
    name: 'Simple Input',
...
export const BLOCK_DEFAULTS = {
  ...
  conversational: {
    ...
    followUpQuestions: 'Ask for examples when the answer is high level.',
    moderatorInstructions: 'Keep the tone friendly and ask one question at a time.',
    conditionsEnabled: false,
  },
  simple_input: {
