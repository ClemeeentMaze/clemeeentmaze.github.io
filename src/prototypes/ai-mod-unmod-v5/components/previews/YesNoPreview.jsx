...
import { ConversationalHeader } from './ConversationalPreview';
 ...
 */
export function YesNoPreview({ block, isModerated = false, progress = 10 }) {
  ...
  return (
    ...
    >
      ...
      <Flex flexDirection="column" gap="LG" className="flex-1 px-8 pt-6 pb-4">
        {isModerated && <ConversationalHeader title={block?.title} />}
