...
/**
 * ConversationalHeader - Compact conversational header for option-heavy blocks.
 *
 * @param {Object} props
 * @param {string} props.title - Prompt shown under the state pill
 */
export function ConversationalHeader({ title }) {
  return (
    <Flex
    ...
    >
      {/* AI Orb */}
      <Box className="relative w-[140px] h-[140px] mb-4">
        <img
          src={orbImage}
          alt="AI Orb"
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140px] h-[140px]"
        />
      </Box>
